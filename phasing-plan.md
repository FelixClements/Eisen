...
| P1.05 | [~] Implement epoch-root key and local-store encryption (AEAD). | project owner | AES-256-GCM key derived per epoch, encrypting local snapshots and enforcing fail-closed counter policy. |
